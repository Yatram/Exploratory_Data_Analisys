...
with(hepc2, plot(date_time, Global_active_power, type = "l", col = "black", 
                 ylab = "Global Active Power", xlab = ""))

with(hepc2, plot(date_time, Voltage, type = "l", col = "black", 
...
with(hepc2, plot(date_time, Global_reactive_power, type = "l", col = "black", 
